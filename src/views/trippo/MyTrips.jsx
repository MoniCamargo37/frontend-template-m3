...
//     try {
//       const plans = await tripPlanService.getTripPlans(); // Aquí deberás hacer una llamada a la API para obtener los planes de viaje del usuario
//       setTripPlans(plans);
//     } catch (error) {
//       console.error(error);
//     }
...
//         setTripPlans(tripPlans.filter((plan) => plan.id !== tripId)); // Aquí estás eliminando el plan de viaje de la lista de planes de viaje del usuario en el estado local
//       }
//     } catch (error) {
//       console.error(error);
//     }
...
//             <div>{plan.city}</div>
//             <div>
//               <button onClick={() => handleView(plan.id)}>Ver detalles</button>
