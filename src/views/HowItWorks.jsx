      ...
      <div className="carousel-card">
        ...
        <div className="text-steps">
          ...
          <p>
            ...
            <a href="http://localhost:3000/"> En este Enlace.</a> Nosotros te mostraremos dos fotos del destino y una breve descripción para que puedas conocer un poco más sobre el lugar. Si te interesa, haz clic en {" "}
            <a href="#" onClick={(e) => {e.preventDefault(); handleCityClick()}}>Continuar</a>.
          </p>
          ...
          <p>
            ...
            <a href="http://localhost:3000/login">aquí</a>.
          </p>
          ...
          <h3>Comparte, borra o agrega más detalles:</h3>
          <p>
